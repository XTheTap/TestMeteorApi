...
public class AppDbContext : DbContext
{
    ...
    public DbSet<MeteorRecclass> MeteorRecclasses => Set<MeteorRecclass>();
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<MeteorRecclass>(entity =>
        {
            entity.ToTable("meteor_recclass");
        ...
        modelBuilder.Entity<Meteorite>(entity =>
        {
            ...
            entity.HasOne(m => m.Recclass)
                .WithMany()
                .HasForeignKey(m => m.RecclassId)
